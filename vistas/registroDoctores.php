    ...
    <form class="colorito" id="colorito" method="POST" action="../controlador/ctrlRegistroDoc.php">
      ...
      <div class="sexo">
        ...
        <div class="especialidad">
          <label for="form-check" class="text-white">Especialidad</label>
          <div class="sexotexts">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="inlineRadio1" value="Psicologia" name="espec" required>
              <label class="form-check-label text-white" for="inlineRadio1">Psicologia</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="inlineRadio2" value="Doctor General" name="espec">
              <label class="form-check-label text-white" for="inlineRadio2">Doctorado General</label>
            </div>

            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="inlineRadio2" value="Nutricionista" name="espec">
              <label class="form-check-label text-white" for="inlineRadio2">Nutricionista</label>
            </div>
          </div>
        </div>

...
<head>
    ...
    <link rel="stylesheet" href="../css/contac.css?v=<?php echo time(); ?>">
    <script src="../js/scrollreveal.js"></script>
    <script src="../js/alertaper.js?v=<?php echo time(); ?>"></script>
...
<body>
      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse " id="navbarNav">
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active fs-6 navbar-brand" href="../vistas/contactanos.php">CONTACTANOS</a>
              </li>
              <li class="nav-item">
    ...
    <div class="div-form">
      <form class="colorito" id="colorito" method="POST" action="../controlador/crtContactanos.php">
        <label for="colorito" class="text-white fs-5">CONTACTANOS</label>
        <div class="row">
          <div class="col">
        ...
        <div class="sexo">
          ...
          <div class="sexotexts">
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio" id="inlineRadio1" value="Hombre" name="sexo" required>
              <label class="form-check-label text-white" for="inlineRadio1">Hombre</label>
            </div>
            <div class="form-check form-check-inline">
              <input class="form-check-input" type="radio"  id="inlineRadio2" value="Mujer" name="sexo" required>
